...
/// <summary>
/// Assembles MOBI databases byte by byte, the way kindlegen would.
/// </summary>
/// <remarks>
/// Deliberately not built on <c>PalmDbContainer</c> or <c>MobiDocument</c>. These
/// fixtures exist to prove that the code under test reads and reproduces a real
/// file's layout — its record table, its EXTH padding, the records it carries that
/// this build has no field for — and a fixture generated by that same code could
/// not prove any of it.
/// </remarks>
