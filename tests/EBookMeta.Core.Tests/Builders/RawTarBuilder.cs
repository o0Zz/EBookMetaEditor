...
/// <summary>
/// Assembles TAR archives byte by byte, the way <c>tar</c> would.
/// </summary>
/// <remarks>
/// Deliberately not built on <c>TarContainer</c>. The point of these fixtures is
/// to carry the things a real archive carries and this build has no reason to
/// understand — a mode, an owner, a group name, ten kilobytes of trailing padding
/// — so that a save can be shown to preserve them. A fixture generated by the
/// same code under test could not show that.
/// </remarks>
